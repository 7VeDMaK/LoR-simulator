...
SKILL_TREE = {
    ...
    "Ветка 2: Лучший из Лучших": [
        {"code": "2.1", "id": "natural_genius", "req": None},
        {"code": "2.2", "id": "celestial_eyes", "req": "natural_genius"},
        {"code": "2.3", "id": "cleave_void", "req": "celestial_eyes"},  # Разрез Пустоты (часть 2.2)
        {"code": "2.4", "id": "watch_and_learn", "req": "celestial_eyes"},
        {"code": "2.5", "id": "right_of_the_first", "req": "watch_and_learn"},
        {"code": "2.5 Опц. А", "id": "black_flash", "req": "right_of_the_first"},
        {"code": "2.5 Опц. Б", "id": "blue_flash", "req": "right_of_the_first"},
        {"code": "2.6", "id": "role_model", "req": "right_of_the_first"},
        {"code": "2.7", "id": "mockery", "req": "role_model"},
        {"code": "2.8", "id": "plot_armor_v2", "req": "mockery"},
        {"code": "2.9", "id": "muted", "req": "plot_armor_v2"},
        {"code": "2.10", "id": "just_getting_started", "req": "muted"},
    ],
    "Ветка 3: Неутомимый": [
