...
class TalentSequentialLuck(BasePassive):
    ...
    description = (
        "7.3 Провал броска: Вы получаете (20 - кубик) очков удачи.\n"
        "Активно (в проверках): Можно потратить Удачу, чтобы превратить провал в успех (цена x2)."
    )
    is_active_ability = False  # Логика встроена в UI проверок
