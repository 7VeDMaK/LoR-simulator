...
WEAPON_REGISTRY = {
    ...
    "lilith_scythe": Weapon(
        ...
        name="Коса 'Sinfoil'",
        rank=8,
        description="medium. Фирменное оружие Лилит. Длинное лезвие позволяет контролировать дистанцию.",
        stats={},
        weapon_type="medium"
    ),
...
"hollow_moon_sword": Weapon(
        id="hollow_moon_sword",
        name="Меч полой луны[空月之劍]",
        rank=6,
        description=(
            "Одачи длинной 132 сантиметров, слегка изогнутое, одностороннее лезвие. "
            "Лезвие стигийско-синего цвета, цуба - простая, круглая, серая. "
            "Рукоять алая. Ножны для одачи белые.\n"
            "• Свойство: Игнорирует часть сопротивления режущему урону (до +0.25 к множителю, макс. 1.0)."
        ),
        stats={}, # Можно добавить бонусы, например {"heavy_weapon": 2}, если нужно
        passive_id="weapon_hollow_moon",
        weapon_type="heavy"
    ),
}